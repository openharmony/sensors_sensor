...
int32_t SensorBasicDataChannel::CreateSensorBasicChannel()
{
    ...
    if (socketpair(AF_UNIX, SOCK_SEQPACKET, 0, socketPair) != 0) {
        HiSysEventWrite(HiviewDFX::HiSysEvent::Domain::SENSOR, "SENSOR_DATA_CHANNEL_EXCEPTION",
...
const std::unordered_map<uint32_t, SensorData> &SensorBasicDataChannel::GetDataCacheBuf() const
{
