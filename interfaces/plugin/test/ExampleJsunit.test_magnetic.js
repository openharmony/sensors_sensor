...
describe("SensorJsTest", function () {
    ...
    it("SensorJsTest004", 0, async function (done) {
        sensor.once(sensor.SensorType.getGeomagneticField, callback);
        setTimeout(()=>{
            expect(true).assertTrue();
            done();
        }, 500);
    ...
    it("SensorJsTest005", 0, function (done) {
        ...
        try{
            sensor.once(sensor.SensorType.getGeomagneticField, onceSensorCallback, 5);
        } catch (error) {
            console.info(error);
            expect(true).assertTrue();
            done();
    ...
    it("SensorJsTest007", 0, async function (done) {
        ...
        sensor.on(sensor.SensorType.getGeomagneticField, onSensorCallback);
        sensor.off(sensor.SensorType.getGeomagneticField, onSensorCallback);
        setTimeout(()=>{
            expect(true).assertTrue();
            done();
        }, 500);
    ...
    it("SensorJsTest009", 0, async function (done) {
        sensor.on(sensor.SensorType.getGeomagneticField, callback);
        sensor.on(sensor.SensorType.getGeomagneticField, callback2);
        setTimeout(()=>{
            console.info('----------------------SensorJsTest009 off in---------------------------');
            sensor.off(sensor.SensorType.getGeomagneticField);
    ...
    it("SensorJsTest010", 0, async function (done) {
        ...
        setTimeout(()=>{
            ...
            sensor.off(sensor.SensorType.getGeomagneticField, callback);
            console.info('----------------------SensorJsTest010 off end---------------------------');
        }, 500);
        setTimeout(()=>{
            console.info('----------------------SensorJsTest010 off in---------------------------');
            sensor.off(sensor.SensorType.getGeomagneticField, callback2);
            console.info('----------------------SensorJsTest010 off end---------------------------');
            done();
        }, 1000);
    })
    ...
    it("SensorJsTest011", 0, async function (done) {
        ...
        sensor.on(sensor.SensorType.getGeomagneticField, callback, {'interval': 100000000});
        sensor.once(sensor.SensorType.getGeomagneticField, callback2);
        setTimeout(()=>{
    ...
    it("SensorJsTest012", 0, async function (done) {
        ...
        sensor.on(sensor.SensorType.getGeomagneticField, callback, {'interval': 100000000});
        sensor.on(sensor.SensorType.getGeomagneticField, callback2, {'interval': 100000000});
        setTimeout(()=>{
