...
describe("SensorJsTest", function () {
    ...
    it("SensorJsTest001", 0, async function (done) {
        ...
        let promise = new Promise((resolve, reject) => {
            sensor.on(266, function(error, data) {
                if (error) {
                    ...
                    console.info('SensorJsTest001  on success, step: ' + data.step);
        ...
        let promise = new Promise((resolve, reject) => {
            sensor.on(266, function(error, data) {
                if (error) {
                    ...
                    console.info('SensorJsTest003  on success step: ' + data.step);
                    expect(typeof(data.step)).assertEqual("number");
    ...
    it("SensorJsTest004", 0, function () {
        ...
        sensor.on(266, function(){}, {'interval': 100000000}, 5);
        expect(true).assertTrue();
    ...
    it("SensorJsTest005", 0, async function (done) {
        function onceSensorCallback(error, data) {
            if (error) {
                ...
                console.info('SensorJsTest005  once success step: ' + data.step);
                expect(typeof(data.step)).assertEqual("number");
            }
            setTimeout(()=>{
                done();
        ...
        sensor.once(266, onceSensorCallback);
    })
        ...
        let promise = new Promise((resolve, reject) => {
            sensor.on(266, function(error, data) {
                if (error) {
                    ...
                    console.info('SensorJsTest014  on success step: ' + data.step);
                    expect(typeof(data.step)).assertEqual("number");
                    setTimeout(()=>{
                        resolve();
                    }, 500);
            ...
            return new Promise((resolve, reject) => {
                sensor.on(266, function(error, data) {
                    if (error) {
                        ...
                        console.info('SensorJsTest015  on2 success step: ' + data.step);
                        expect(typeof(data.step)).assertEqual("number");
                        setTimeout(()=>{
                            resolve();
                        }, 500);
        ...
        let onPromise1 = new Promise((resolve, reject) => {
            sensor.on(266, function(error, data) {
                if (error) {
                    ...
                    console.info('SensorJsTest015  on1 success step: ' + data.step);
                    expect(typeof(data.step)).assertEqual("number");
                    setTimeout(()=>{
                        resolve();
                    }, 500);
    ...
    it("SensorJsTest016", 0, async function (done) {
        ...
        function oncePromise() {
            return new Promise((resolve, reject) => {
                sensor.once(266, function(error, data) {
                    if (error) {
                        ...
                        console.info('SensorJsTest016  once success step: ' + data.step);
                        expect(typeof(data.step)).assertEqual("number");
                        setTimeout(()=>{
                            resolve();
                        }, 500);
        ...
        let onPromise1 = new Promise((resolve, reject) => {
            sensor.on(266, function(error, data) {
                if (error) {
                    ...
                    console.info('SensorJsTest016  on1 success step: ' + data.step);
                    expect(typeof(data.step)).assertEqual("number");
                    setTimeout(()=>{
                        resolve();
                    }, 500);
