...
static napi_value CreateEnumSensorType(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_STATIC_PROPERTY("SENSOR_TYPE_ID_POSTURE", GetNapiInt32(env, SENSOR_TYPE_ID_POSTURE)),
...
static napi_value CreateEnumSensorId(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_STATIC_PROPERTY("POSTURE", GetNapiInt32(env, SENSOR_TYPE_ID_POSTURE)),
