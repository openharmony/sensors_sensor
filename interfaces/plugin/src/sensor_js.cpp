...
napi_value CreateEnumSensorType(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_STATIC_PROPERTY("SENSOR_TYPE_ID_LINEAR_ACCELERATION", GetNapiInt32(SENSOR_TYPE_ID_LINEAR_ACCELERATION, env)),
        DECLARE_NAPI_STATIC_PROPERTY("SENSOR_TYPE_ID_ROTATION_VECTOR", GetNapiInt32(SENSOR_TYPE_ID_ROTATION_VECTOR, env)),
        DECLARE_NAPI_STATIC_PROPERTY("SENSOR_TYPE_ID_AMBIENT_TEMPERATURE", GetNapiInt32(SENSOR_TYPE_ID_AMBIENT_TEMPERATURE, env)),
        ...
        DECLARE_NAPI_STATIC_PROPERTY("SENSOR_TYPE_ID_GYROSCOPE_UNCALIBRATED", GetNapiInt32(SENSOR_TYPE_ID_GYROSCOPE_UNCALIBRATED, env)),
        DECLARE_NAPI_STATIC_PROPERTY("SENSOR_TYPE_ID_SIGNIFICANT_MOTION", GetNapiInt32(SENSOR_TYPE_ID_SIGNIFICANT_MOTION, env)),
        DECLARE_NAPI_STATIC_PROPERTY("SENSOR_TYPE_ID_PEDOMETER_DETECTION", GetNapiInt32(SENSOR_TYPE_ID_PEDOMETER_DETECTION, env)),
        ...
        DECLARE_NAPI_STATIC_PROPERTY("SENSOR_TYPE_ID_ACCELEROMETER_UNCALIBRATED", GetNapiInt32(SENSOR_TYPE_ID_ACCELEROMETER_UNCALIBRATED, env)),
    };
