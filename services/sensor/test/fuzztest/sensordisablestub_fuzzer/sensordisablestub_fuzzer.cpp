...
#include "sensordisablestub_fuzzer.h"
...
void SetUpTestCase()
{
    ...
    TokenInfoParams infoInstance = {
        ...
        .perms = perms,
        .acls = nullptr,
        .processName = "SensorDisableStubFuzzTest",
        .aplStr = "system_core",
    };
...
bool OnRemoteRequestFuzzTest(const uint8_t *data, size_t size)
{
    ...
    g_sensorService->OnRemoteRequest(static_cast<uint32_t>(SensorInterfaceCode::DISABLE_SENSOR),
        datas, reply, option);
    return true;
}
}  // namespace Sensors
