...
#include "destroydatachannelstub_fuzzer.h"
...
void SetUpTestCase()
{
    ...
    TokenInfoParams infoInstance = {
        ...
        .perms = perms,
        .acls = nullptr,
        .processName = "DestroyDataChannelStubFuzzTest",
        .aplStr = "system_core",
    };
...
bool OnRemoteRequestFuzzTest(const uint8_t *data, size_t size)
{
    ...
    g_sensorService->OnRemoteRequest(static_cast<uint32_t>(SensorInterfaceCode::DESTROY_SENSOR_CHANNEL),
        datas, reply, option);
    return true;
}
}  // namespace Sensors
