...
int32_t HdiConnection::ConnectHdi()
{
    ...
    HiSysEvent::Write(HiviewDFX::HiSysEvent::Domain::SENSORS_SENSOR, "SENSOR_HDF_SERVICE_EXCEPTION",
        HiSysEvent::EventType::FAULT, "FUNC_NAME", "ConnectHdi", "ERROR_CODE", CONNECT_SENSOR_HDF_ERR);
...
int32_t HdiConnection::GetSensorList(std::vector<Sensor>& sensorList)
{
    ...
    if (ret != 0) {
        HiSysEvent::Write(HiviewDFX::HiSysEvent::Domain::SENSORS_SENSOR, "SENSOR_HDF_SERVICE_EXCEPTION",
            HiSysEvent::EventType::FAULT, "FUNC_NAME", "GetSensorList", "ERROR_CODE", ret);
...
int32_t HdiConnection::EnableSensor(int32_t sensorId)
{
    ...
    if (ret != 0) {
        HiSysEvent::Write(HiviewDFX::HiSysEvent::Domain::SENSORS_SENSOR, "SENSOR_HDF_SERVICE_EXCEPTION",
            HiSysEvent::EventType::FAULT, "FUNC_NAME", "EnableSensor", "ERROR_CODE", ret);
        SEN_HILOGE("connect v1_0 hdi failed");
        return ret;
    }
...
int32_t HdiConnection::DisableSensor(int32_t sensorId)
{
    ...
    if (ret != 0) {
        HiSysEvent::Write(HiviewDFX::HiSysEvent::Domain::SENSORS_SENSOR, "SENSOR_HDF_SERVICE_EXCEPTION",
            HiSysEvent::EventType::FAULT, "FUNC_NAME", "DisableSensor", "ERROR_CODE", ret);
...
int32_t HdiConnection::SetBatch(int32_t sensorId, int64_t samplingInterval, int64_t reportInterval)
{
    ...
    if (ret != 0) {
        HiSysEvent::Write(HiviewDFX::HiSysEvent::Domain::SENSORS_SENSOR, "SENSOR_HDF_SERVICE_EXCEPTION",
            HiSysEvent::EventType::FAULT, "FUNC_NAME", "SetBatch", "ERROR_CODE", ret);
...
int32_t HdiConnection::SetMode(int32_t sensorId, int32_t mode)
{
    ...
    if (ret != 0) {
        HiSysEvent::Write(HiviewDFX::HiSysEvent::Domain::SENSORS_SENSOR, "SENSOR_HDF_SERVICE_EXCEPTION",
            HiSysEvent::EventType::FAULT, "FUNC_NAME", "SetMode", "ERROR_CODE", ret);
...
int32_t HdiConnection::SetOption(int32_t sensorId, int32_t option)
{
    ...
    if (ret != 0) {
        HiSysEvent::Write(HiviewDFX::HiSysEvent::Domain::SENSORS_SENSOR, "SENSOR_HDF_SERVICE_EXCEPTION",
            HiSysEvent::EventType::FAULT, "FUNC_NAME", "SetOption", "ERROR_CODE", ret);
...
int32_t HdiConnection::RegisteDataReport(ZReportDataCb cb, sptr<ReportDataCallback> reportDataCallback)
{
    ...
    if (ret != 0) {
        HiSysEvent::Write(HiviewDFX::HiSysEvent::Domain::SENSORS_SENSOR, "SENSOR_HDF_SERVICE_EXCEPTION",
            HiSysEvent::EventType::FAULT, "FUNC_NAME", "RegisteDataReport", "ERROR_CODE", ret);
...
int32_t HdiConnection::DestroyHdiConnection()
{
    ...
    if (ret != 0) {
        HiSysEvent::Write(HiviewDFX::HiSysEvent::Domain::SENSORS_SENSOR, "SENSOR_HDF_SERVICE_EXCEPTION",
            HiSysEvent::EventType::FAULT, "FUNC_NAME", "DestroyHdiConnection", "ERROR_CODE", ret);
