...
#include "unblocksensordatabyclientstub_fuzzer.h"
...
void SetUpTestCase()
{
    ...
    TokenInfoParams infoInstance = {
        ...
        .perms = perms,
        .acls = nullptr,
        .processName = "UnblockSensorDataByClientStubFuzzTest",
        .aplStr = "system_core",
    };
...
bool OnRemoteRequestFuzzTest(const uint8_t *data, size_t size)
{
    ...
    g_service->OnRemoteRequest(static_cast<uint32_t>(ISensorServiceIpcCode::COMMAND_UNBLOCK_SENSOR_DATA_BY_CLIENT),
        datas, reply, option);
    return true;
}
} // namespace Sensors
