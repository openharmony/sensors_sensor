...
#include "reportsensorsysevent_fuzzer.h"
...
bool ReportSensorSysEventFuzzTest(const uint8_t *data, size_t size)
{
    SetUpTestCase();
    size_t startPos = 0;
    int32_t sensorId = 0;
    ...
    g_service->ReportSensorSysEvent(sensorId, enable, pid);
    return true;
}
}  // namespace Sensors
}  // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::Sensors::ReportSensorSysEventFuzzTest(data, size);
    return 0;
}
