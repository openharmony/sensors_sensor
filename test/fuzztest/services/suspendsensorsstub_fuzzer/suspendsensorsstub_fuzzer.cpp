...
#include "suspendsensorsstub_fuzzer.h"
...
void SetUpTestCase()
{
    ...
    TokenInfoParams infoInstance = {
        ...
        .perms = perms,
        .acls = nullptr,
        .processName = "SuspendSensorsStubFuzzTest",
        .aplStr = "system_core",
    };
...
bool OnRemoteRequestFuzzTest(const uint8_t *data, size_t size)
{
    ...
    g_service->OnRemoteRequest(static_cast<uint32_t>(ISensorServiceIpcCode::COMMAND_SUSPEND_SENSORS),
        datas, reply, option);
    return true;
}
} // namespace Sensors
