...
static napi_value Init(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_WRITABLE_FUNCTION("getSensorList", GetSensorList),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSensorListSync", GetSensorListSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSingleSensor", GetSingleSensor),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSingleSensorSync", GetSingleSensorSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSensorListByDeviceSync", GetSensorListByDeviceSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSingleSensorByDeviceSync", GetSingleSensorByDeviceSync),
